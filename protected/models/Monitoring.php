...
class Monitoring extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'separation_date_input' => 'Data de Entrada',
			'separation_date_output' => 'Data de Saída',
			'separation_provider_id' => 'Prestador de Serviço da Separação',
			...
			'needlework_provider_id' => 'Prestador de Serviço do Bordado',
			'seam_date_input' => 'Data de Entrada',
			'seam_date_output' => 'Data de Saída',
			'seam_provider_id' => 'Prestador de Serviço de Costura',
			...
			'wash_provider_id' => 'Prestador de Serviço da Lavagem',
			...
			'expedition_defects' => 'Defeitos da Expedição',
